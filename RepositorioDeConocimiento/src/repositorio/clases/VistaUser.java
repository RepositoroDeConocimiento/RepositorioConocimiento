...
class VistaUser extends Form implements CommandListener, OrientationListener {
    ...
    private Form login;
    public VistaUser(Inicio midlet) {
        super("");
        ...
        StringItem titulo = new StringItem("Bienvenido:","Usuario");
        super.append(titulo);
        ...
        try {
    	    imagen= new ImageItem("", Image.createImage("/img/user.png"), ImageItem.LAYOUT_CENTER, "Logo de Java");
